...
export default function Screen() {
  ...
  const isSubmitting = navigation.formAction === "/myLogin";

  return (
    <Form className="flex flex-col gap-4 w-75% max-w-64 mx-auto mt-10" method="post" action="/myLogin">
