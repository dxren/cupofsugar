    ...
    <>
      ...
      <dialog id="add-item-modal" className="modal">
        <div className="modal-box">
          <button
            className="btn btn-ghost btn-circle absolute top-0 right-0 p-2 mr-px mt-px"
            onClick={() => document.getElementById("add-item-modal")?.close()}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <Form
            className="flex flex-col gap-4 w-75% max-w-64 mx-auto"
            method="post"
            action="/dorothy"
          >
